<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $psswd = mysqli_real_escape_string($db,$_POST['psswd']); 
      
      $sql = "SELECT emp_id FROM employees WHERE uname = '$uname' and psswd = '$psswd'";
...
<html>
 ...
 <link href="assets/css/bootstrap.min.css" rel="stylesheet" />
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
      ...
      <title>Loginuser@Parinati</title>
  ...
  <div class="container-fluid">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item">
        <img src="img/wall1.png" alt="Los Angeles" width="1200" height="700">
        <div class="carousel-caption">
    ...
    -->
        ...
        <div class="card card-container">
            ...
            <form class="form-signin" method="post" action="">
                ...
                <input type="password" id="inputPassword" class="form-control" placeholder="Password" required name="psswd">
