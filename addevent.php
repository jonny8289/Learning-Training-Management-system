...
if(!empty($_POST['title'])) {
  ...
  $sql="INSERT INTO events(title,tdesc,authors,ar_number,alt_ar_number,g_id,date,created,status)VALUES('".$_POST['title']."','".$_POST['tdesc']."','".$_POST['authors']."','".$_POST['ar_number']."','".$_POST['alt_ar_number']."','".$_POST['g_id']."','".$_POST['date']."','".$_POST['created']."','".$_POST['status']."')";
...
<div class="col-md-3">
    <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Event Title"  name="title" ng-model="title">
    </div>
</div>
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Authors Name"  name="authors" ng-model="authors">
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Authors Number"  name="ar_number" ng-model="ar_number">
        </div>
    </div>
        
<div class="col-md-6">
    <div class="form-group">
        <label>Authors Alternate Number</label>
        <input type="text" class="form-control" placeholder="Authors Alternate Number"  name="alt_ar_number" ng-model="alt_ar_number">
    </div>
</div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="date" class="form-control" placeholder="Event Date"  name="date" ng-model="date">
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="date" class="form-control" placeholder="Event Date"  name="created" ng-model="created">
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Event Date"  name="tdsec" ng-model="tdesc">
...
<div class="row">
      <div class="col-md-6">
        <div class="form-group">
            <label>Status</label>
          <select name="status" class="form-control" placeholder="Event Status">
                ...
                <div class="content">
                                <div class="author">
                                     ...
                                     <img class="avatar border-gray" src="" alt='...'/>
                                      ...
                                      <h4 class="title">{{title}}<br />  
                                      <small>{{authors}}</small>
                                      </h4>
                                    
                                </div>
                                <p class="description text-center">
                                 {{ar_number}} / {{alt_ar_number}}
                                </p>
                                <p class="description text-center">
                                 {{date}}
                                </p>
