...
<head>
    ...
    <title>Parinati@UpdateEvent</title>
...
<a class="navbar-brand" href="updateevent.php">Update Event</a>
</div>
...
<div class='content'>
    <div class='author'>
        ...
        <img class='avatar border-gray' src='assets/img/faces/face-3.jpg' alt='...'/>
            <h4 class='title'>".$row["id"]."</h4>
            <h4 class='title'>".$row["title"]."<br />
            <small>".$row["authors"]."</small>
            </h4>
        
    </div>
    <p class='description text-center'> ".$row["ar_number"]." /".$row["alt_ar_number"]."
                            </p>
...
<p class='description text-center'>
                          <a href='updatingevent.php?id=".$row['id']."'><button class='btn btn-info btn-fill '><font color='white'>Edit</font></button></a></p>
                            </div>
