...
<head>
    ...
    <title>Parinati@ViewEvent</title>
...
<a class="navbar-brand" href="viewevent.php">View Event</a>
</div>
...
<p class='description text-center'> ".$results["tdesc"]."
                           ...
                           <p class='description text-center'> ".$results["status"]."
                            </p>
                            </div>
                            <hr>
...
<p class='description text-center'> ".$row["tdesc"]."
                          ...
                          <p class='description text-center'> ".$row["status"]."
                            </p>
                            </div>
                            <hr>
                            <div class='text-center'>
