...
<head>
    ...
    <title>Parinati@UpdateUser</title>
...
<div class='content'>
    <div class='author'>
       ...
       <img class='avatar border-gray' src='view.php?emp_id=".$results['emp_id']."' alt='...'/>
            <h4 class='title'>".$results["emp_id"]."</h4>
            <h4 class='title'>".$results["fname"]."".$results["lname"]."<br />
            <small>".$results["uname"]."</small>
            <small>".$results["psswd"]."</small>
            </h4>
...
<a href='updatinguser.php?emp_id=".$row['emp_id']."'><button class='btn btn-info btn-fill '><font color='white'>Edit</font></button></a></p>
                            </div>
                            <hr>
...
<div class='content'>
    <div class='author'>
         ...
         <img class='avatar border-gray' src='view.php?emp_id=".$row['emp_id']."' alt='...'/>
            <h4 class='title'>".$row["emp_id"]."</h4>
            <h4 class='title'>".$row["fname"]."".$row["lname"]."<br />
            <small>".$row["uname"]."</small>
